...
| **项目管理** | 五大领域（内容创作 / AI 学习 / 健康 / 课程 / 生活）专属流水线，进度动态计算 |
...
- **项目详情** —— 各领域完整子结构（内容流水线 / AI 学习列表 / 健康里程碑 / 课程课时 / 生活项），含“来自收集箱的任务”区块
...
**manifest 关键配置：**
- `name`: "玥莹 Personal OS" / `short_name`: "Personal OS"
...
<p align="center">Made with ♥ by 玥莹 · Personal OS</p>
